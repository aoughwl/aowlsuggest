...
proc styleFlag(cat: string; ok: var bool): string =
  ...
  of "redundant-parens", "parens": "--redundant-parens:warn"
  of "empty-string", "empty-str": "--empty-string:warn"
  ...
  of "addr", "addr-of": "--addr:warn"
  of "asm", "asm-block": "--asm:warn"
...
proc flagForCode(code: string): string =
  ...
  of "redundant-parens-condition": "--redundant-parens:warn"
  of "empty-string-concat": "--empty-string:warn"
  ...
  of "addr-of": "--addr:warn"
  of "asm-block": "--asm:warn"
...
proc usage(): int =
  ...
  write stderr, "                     bare-except  cast  converter  addr  asm (opinions)\n"
